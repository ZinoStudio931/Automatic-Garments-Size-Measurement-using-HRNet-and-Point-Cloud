...
def main():
    ...
    # >>> print customers' input arguments 
    ...
    model = eval('models.'+cfg.MODEL.NAME+'.get_pose_net')( # 'pose_hrnet'
        cfg, is_train=False
    ) # ./lib/models/pose_hrnet.py/get_pose_net -> eval 
...
# => load 52239 samples    # <- The number of labels (?) 
    ...
    # *** 'joints_3d', 'joints_3d_vis', 'center', 'scale' ... *** 
    # : DataLoader() got instance meta, and read actual image in 'validate'>enumerate()>JointsDataset.py
...
if __name__ == '__main__':
    main()
    # => writing results json to output/deepfashion2/pose_hrnet/w48_384x288_adam_lr1e-3/2022-01-07-18-26/results/keypoints_validation_results_0.json